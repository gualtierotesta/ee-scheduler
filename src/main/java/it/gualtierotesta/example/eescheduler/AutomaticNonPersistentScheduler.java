...
/**
 * Example of an automatic NON persistent scheduler
 *
 * @author Gualtiero Testa <http://www.gualtierotesta.it>
 */
@Startup
@Stateless
public class AutomaticNonPersistentScheduler {
    ...
    @Schedule(second = "*/7",
            minute = "*",
            hour = "*",
            info = "AutomaticNonPersistentScheduler",
            persistent = false)
    public void process() {
        log.info(myService.sayCiao("AutomaticNonPersistentScheduler"));
    }
